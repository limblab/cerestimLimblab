...
chanList = [25];
aux_chan = [55,26];
aux_chan_wave = [3,1]; % 1 = cathodic first from pulseAmpList, 2 = anodic first from pulseAmpList, 3 = cathodic first small
use_aux_chan = 1;
nomFreq=10;
nTests=80;

interpulseList = 53;
prefix='Han_chan25stim_auxChan55_'; % no '_' needed;
folder='C:\H_\';
